...
Func DonateCC($Check = False)
	...
	If ($CurCamp >= ($TotalCamp * $fulltroop / 100) * .95) And $CommandStop = - 1 Then
		If $debugsetlog = 1 Then Setlog("Total troops >95%, Skipped..", $COLOR_PURPLE)
		Return ; skip donate if >95% full troop
	EndIf
